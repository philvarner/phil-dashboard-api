...
VECTOR_TILESERVER_URL = os.environ.get("VECTOR_TILESERVER_URL", config_object.get("VECTOR_TILESERVER_URL", ""))
TITILER_SERVER_URL = os.environ.get("TITILER_SERVER_URL", config_object.get("TITILER_SERVER_URL", ""))
API_VERSION_STR = "/v1"
