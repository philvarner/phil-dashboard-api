...
VECTOR_TILESERVER_URL = os.environ.get("VECTOR_TILESERVER_URL",
                                       config_object.get("VECTOR_TILESERVER_URL")) or ""
TITILER_SERVER_URL = os.environ.get("TITILER_SERVER_URL",
                                    config_object.get("TITILER_SERVER_URL")) or ""
